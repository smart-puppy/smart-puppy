...
import { ResumeTable } from "cv-parser/ResumeTable";
import { FlexboxSpacer } from "components/FlexboxSpacer";
import { ResumeParserAlgorithmArticle } from "cv-parser/ResumeParserAlgorithmArticle";
...
const RESUME_EXAMPLES = [
  ...
  },
  {
    ...
    description: (
      <span>
        here is a bad cv that wont pass commen ats Systems -{" "}
        <Link href="/cv-builder">Link</Link>
      </span>
    ),
  },
];
        ...
        <div className="flex px-6 text-gray-900 md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:overflow-y-scroll">
          ...
          <section className="max-w-[600px] grow">
            ...
            <Paragraph smallMarginTop={true}>
              This playground showcases the smart puppy cv parser and its
              ability to parse information from a cv PDF. Click around the
